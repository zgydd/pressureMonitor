...
onmessage = function(event) {
    ...
    for (var i = 0; i < innerMatrix.length; i++) {
        ...
        for (var j = 0; j < innerMatrix[i].length; j++) {
            if (innerMatrix[i][j] > 0) {
                ...
                if (j > 0 && j < innerMatrix[i].length - 1 && innerMatrix[i][j - 1] > 0 && innerMatrix[i][j + 1] > 0) {
    ...
    for (var i = 0; i < tmpScan.length; i++) {
        for (var j = 0; j < tmpScan.length; j++) {
            if (Math.abs(tmpScan[i].idxTmp - tmpScan[j].idxTmp) === 1 && (((tmpScan[i].Sy >= tmpScan[j].Sy - 1 && tmpScan[i].Sy <= tmpScan[j].Ey + 1) || (tmpScan[i].Ey >= tmpScan[j].Sy - 1 && tmpScan[i].Sy <= tmpScan[j].Ey + 1)) || ((tmpScan[j].Sy >= tmpScan[i].Sy - 1 && tmpScan[j].Sy <= tmpScan[i].Ey + 1) || (tmpScan[j].Ey >= tmpScan[i].Sy - 1 && tmpScan[j].Sy <= tmpScan[i].Ey + 1)))) {
                switch (true) {
                    case (tmpScan[i].group === undefined && tmpScan[j].group === undefined):
                        tmpScan[i].group = groupNum;
                        tmpScan[j].group = groupNum;
                        groupNum++;
                        tmpScan[i].minX = (tmpScan[i].minX === undefined) ? Math.min(tmpScan[i].idxTmp, tmpScan[j].idxTmp) : Math.min(tmpScan[i].idxTmp, tmpScan[j].idxTmp, tmpScan[i].minX);
                        tmpScan[i].maxX = (tmpScan[i].maxX === undefined) ? Math.max(tmpScan[i].idxTmp, tmpScan[j].idxTmp) : Math.max(tmpScan[i].idxTmp, tmpScan[j].idxTmp, tmpScan[i].maxX);
                        tmpScan[j].minX = (tmpScan[j].minX === undefined) ? Math.min(tmpScan[i].idxTmp, tmpScan[j].idxTmp) : Math.min(tmpScan[i].idxTmp, tmpScan[j].idxTmp, tmpScan[j].minX);
                        tmpScan[j].maxX = (tmpScan[j].maxX === undefined) ? Math.max(tmpScan[i].idxTmp, tmpScan[j].idxTmp) : Math.max(tmpScan[i].idxTmp, tmpScan[j].idxTmp, tmpScan[j].maxX);
                        break;
