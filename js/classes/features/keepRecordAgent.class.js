...
var Keeprecordagent = (function keeprecordagentClosure() {
    ...
    function Keeprecordagent(productInfo, heatmapHook) {
        ...
        this.__DOM__.append($('<img src="./assets/images/logo.png" />').addClass('last-record')).append($('<img src="./assets/images/logo.png" />').addClass('last-record')).append($('<img src="./assets/images/logo.png" />').addClass('last-record'));
    };
    Keeprecordagent.prototype = {
        saveRecord: function() {
            ...
            if (!env.testMode) logic._interfaceConnecter('keepRecord', this, env);
                ...
                io._saveKeepRecord(this.activedRecord);
        ...
        sendRecord: function() {
            ...
            if (this.activedRecord.map) {
                this.__DOM__.children('.last-record').get(this.cursorShowMap).src = this.activedRecord.map.toDataURL();
                if (this.bySend) this.saveRecord();
            }
